...
<form class="small bg-white" method="post" action="cadastro.php">
    ...
    <!-- Email --><div class="form-group">
        ...
        <label class="mySmall" id="Help" class="form-text text-muted"></label>
    </div>
    ...
    <!-- Telef --><div class="form-group">
        ...
        <input class="form-control" name="cellphone" id="telephone" onkeypress="telephoneMask()" required maxlength="15">
        <script>
            if (alreadyExist)
            {
